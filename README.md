...
Um SaaS 'Link-in-Bio' de código aberto, construído com Next.js, TypeScript, Tailwind, PostgreSQL (Neon) e Stripe.

---

## 🎯 Visão do Produto

O LinkHub permite que criadores de conteúdo, desenvolvedores e marcas centralizem seus links mais importantes em uma única página pública, customizável e de alta performance.
...
Nosso progresso é gerenciado através do nosso [GitHub Project Board](https://github.com/users/JoaoMendes1/projects/5).

Um roadmap detalhado das fases do projeto está disponível em [ROADMAP.md](ROADMAP.md).
